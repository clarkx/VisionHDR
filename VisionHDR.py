...
def update_panel(self, context):
    ...
    try:
        bpy.utils.unregister_class(VISIONHDR_PT_Init)
    except:
        pass
    VISIONHDR_PT_Init.bl_category = context.user_preferences.addons[__name__].preferences.category
    bpy.utils.register_class(VISIONHDR_PT_Init)
...
#########################################################################################################
class VISIONHDR_OT_EditLight(bpy.types.Operator):
...
#########################################################################################################
class VISIONHDR_OT_AddLightEnv(bpy.types.Operator):
...
#########################################################################################################
class VISIONHDR_OT_SelectPixel(bpy.types.Operator):
...
#########################################################################################################
class VISIONHDR_OT_ActiveWorld(bpy.types.Operator):
...
#########################################################################################################
class VISIONHDR_OT_ActiveLamp(bpy.types.Operator):
    """Make VisionHDR the active world if exist"""
...
#########################################################################################################
"""
class VISIONHDR_PT_Preferences(bpy.types.Panel):
    """Creates a Panel in the Object properties window"""
    bl_idname = "view3d.VISIONHDR_PT_Preferences"
    bl_description = "Env parameter"
...
#########################################################################################################
"""
class VISIONHDR_PT_Edit(bpy.types.Panel):
    """Creates a Panel in the Object properties window"""
    bl_idname = "view3d.VISIONHDR_PT_Edit"
    ...
    def draw(self, context):
        ...
        #---Environment Panel Preferences
            VISIONHDR_PT_Preferences.draw(self, context)
...
#########################################################################################################
"""     
class VISIONHDR_PT_Init(bpy.types.Panel):
    bl_idname = "view3d.VISIONHDR_PT_Init"
        ...
        #---For each layer
            ...
            if objects_on_layer == [] and bpy.data.lamps["VisionHDR_LAMP"]:
                ...
                for self.object in list(set(objects_on_layer)):
                    VISIONHDR_PT_Edit.draw(self, context)
                    cobj = self.cobj
        else:
